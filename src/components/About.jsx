                ...
                <div className="row gx-5 gy-4 align-items-center">
                    ...
                    <div className="col-12 col-lg-5">
                        <div className="about-feature-panel">
                            <h3>Every day, discover:</h3>
                            <ul>
                                <li>Quotes to inspire and motivate</li>
                                <li>Affirmations to build confidence and mindfulness</li>
                                <li>Fun facts to spark curiosity</li>
                                <li>Jokes to keep things light</li>
                                <li>Games that turn daily wisdom into a habit</li>
                            </ul>
                        </div>
                    </div>
                </div>
